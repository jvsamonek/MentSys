...
!async function main(){
    ...
    const Al1 = new Alerta({reason: 'Prazo', projeto_id: allProjetos[0]._id, userId: allUsers[2]._id})
    const Al2 = new Alerta({reason: 'Motivo', projeto_id: allProjetos[1]._id, userId: allUsers[2]._id})
    await Al1.save()
    await Al2.save()
